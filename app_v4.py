...
with col_a:
    ...
    fig_low = px.bar(
        df_facility_low.sort_values("영유아1000명당시설수", ascending=False),
        x="영유아1000명당시설수",
        y="자치구",
        orientation="h",
        text="영유아1000명당시설수",
...
with col_b:
    ...
    fig_risk = px.bar(
        df_risk_high.sort_values("보호구역1개당사고수", ascending=True),
        x="보호구역1개당사고수",
        y="자치구",
        orientation="h",
        text="보호구역1개당사고수",
    ...
    fig_risk.update_traces(texttemplate="%{text:.3f}", textposition="outside")
